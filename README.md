...
Normal AI chat runs through your configured Ollama endpoint, which defaults to your local machine. The panel searches the offline archive first when local wiki/docs are available, and long local AI replies can be stopped from the chat panel. Command suggestions are shown for review only, with extra warnings for risky destructive patterns. Commands such as `web <query>` and `fetch <url>` intentionally use the network.
...
<!-- MUTHUR-STATS:START -->
![Lines of Code](https://img.shields.io/badge/lines%20of%20code-28%2C027-c9d1d9?style=flat-square&labelColor=161b22)
![Project Files](https://img.shields.io/badge/project%20files-139-c9d1d9?style=flat-square&labelColor=161b22)
<!-- MUTHUR-STATS:END -->
